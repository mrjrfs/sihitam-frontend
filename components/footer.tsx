    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">HateSafe</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Advanced AI-powered hate speech detection system helping create safer online communities through
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 S.I.H.I.T.A.M . All rights reserved. Built with ❤️ for safer communities.</p>
        </div>
      </div>
    </footer>
  )
